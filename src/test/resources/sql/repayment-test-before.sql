...
insert into repayment_detail(id, create_time,loan_id,repayment_plan_id,amount,repayment_bank_account)
values('DETAIL2020091400001', '2020-09-14 09:00:01','LOAN0220091400000001','PLAN2020091400001',321,'6225883719240036');

insert into repayment_detail(id, create_time,loan_id,repayment_plan_id,amount,repayment_bank_account)
values('DETAIL2020091400002', '2020-09-14 09:00:01','LOAN0220091400000001','PLAN2020091400001',322,'6225883719240036');

insert into repayment_detail(id, create_time,loan_id,repayment_plan_id,amount,repayment_bank_account)
values('DETAIL2020091400003', '2020-09-14 09:00:01','LOAN0220091400000001','PLAN2020091400001',323,'6225883719240036');
